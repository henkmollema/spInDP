...
class AnimationController:
    ...
    realYAngle = 0
    yAdjustment = 0
    def strafeWalk(self, direction, frameNr, speedMod = 1, keepLeveled = False, danceAngle=False, danceYAngle = 0):
        ...
        if(keepLeveled):
            ...
            if(danceAngle):
                ...
                print("realYAngel: ", self.realYangle)
            else:
                self.realYAngle = self.spider.remoteController.context.aY * 90 * math.pi / 180
    ...
    def turn4Legs(self, xDirection, yDirection, frameNr, speedMod=1):
        ...
        leg2FrameNr = (frameNr - 1) % 4
        leg4FrameNr = (frameNr - 2) % 4
        leg5FrameNr = (frameNr - 3) % 4

        self.startFrame()

        self.sequenceFrame.movements[3] = self.seqCtrl.coordsToLegMovement(5, 0, -5, 3, 100)
        self.sequenceFrame.movements[3] = self.seqCtrl.coordsToLegMovement(5, 0, -5, 3, 100)
